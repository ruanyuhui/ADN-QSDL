...
if __name__ == "__main__":
    ...
    parser.add_argument("run_name", help="name of the run")#parser.add_argument("run_name", help="name of the run")#在run_name前加--   ,default='npy_image',
    ...
    if args.run_name in run_opts and "trainA" in run_opts[args.run_name]:
        run_opts = run_opts[args.run_name]["trainA"]
